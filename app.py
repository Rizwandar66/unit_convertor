...
category = st.selectbox("Select Catagory", ["Distance", "Temperature", "Weight", "Pressure"])
...
if category == "Distance":
   ...
   if st.button("Convert"):
    ...
    from_unit = st.selectbox("From",["Fahrenheit", "Celcius"]) 
    to_unit = st.selectbox("To",["Fahrenheit", "Celcius"])
    value = st.number_input("Enter Value")
    if st.button("Convert"):
